...
void    ImGui_ImplWin32_NewFrame()
{
    ...
    RECT rect;
    if (!Application::game->initialised)
        ::GetClientRect(g_hWnd, &rect);
    else
    {
        rect.left = Application::game->refdef->displayViewport.x;
        rect.top = Application::game->refdef->displayViewport.y;
        rect.right = rect.left + Application::game->refdef->displayViewport.width;
        rect.bottom = rect.top + Application::game->refdef->displayViewport.height;
    }
